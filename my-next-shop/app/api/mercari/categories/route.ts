...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, data: parentRecord, isLeaf: false, fromCache: true });
