// app/api/yahoo_shopping/categories/route.ts
// 사용자용 야후쇼핑 카테고리 조회.
// DB 를 먼저 쓰고, 그 카테고리를 처음 방문했을 때만(테이블이 비어 있을 때 포함) 야후를 기다립니다.
// 오래된 목록은 응답 후 백그라운드로 갱신됩니다. (lib/yahooShoppingCategories.ts 참고)
import { NextResponse } from 'next/server';
import {
  getCategoryChildren,
  getCategoryPathOf,
  isCategoryNotFoundError,
  YAHOO_SHOPPING_ROOT_ID,
} from '@/lib/yahooShoppingCategories';
