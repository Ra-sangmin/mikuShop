...
// 🌟 회원 상세 드로어는 카카오톡 알림톡 관리에서도 열어서 공용 컴포넌트로 뺐습니다.
import MemberDrawer, {
  Avatar, ProviderBadge, GradeBadge, providerOf, PROVIDER_LABEL, realEmail, initialOf,
...
/* ============================================================
   🎨 표시용 도우미 — app/admin/components/MemberDrawer.tsx 로 옮겼습니다.
   ============================================================ */
