          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {[
              ...
              <li key={idx} 
                ...
                padding: '16px 24px', 
                cursor: 'pointer',
                backgroundColor: item.name === '고객 센터' ? '#3b82f6' : 'transparent',
                borderLeft: item.name === '고객 센터' ? '4px solid #fff' : '4px solid transparent',
                color: item.name === '고객 센터' ? '#fff' : '#94a3b8',
                fontWeight: item.name === '고객 센터' ? '600' : '400',
                transition: 'all 0.2s'
              }}>
                {item.name}
              </li>
