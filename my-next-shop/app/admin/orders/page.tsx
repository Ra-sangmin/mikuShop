            ...
            <section className="ord-detail-sec">
              ...
              {a ? (
                <dl className="ord-detail-list">
                  <div><dt>받는 분</dt><dd className="is-strong">{a.recipientName}</dd></div>
                  <div><dt>연락처</dt><dd className="is-mono">{a.phone || '-'}</dd></div>
                  <div><dt>주소</dt><dd>
                    <span className="ord-detail-zip">{a.zipCode}</span> {a.address}
                    {a.detailAddress && <><br />{a.detailAddress}</>}
                  </dd></div>
                  <div><dt>통관번호</dt><dd className="is-mono">{a.personalCustomsCode || '-'}</dd></div>
                </dl>
              ) : (
