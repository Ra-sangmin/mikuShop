        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div className="anim-item delay-1" style={{ 
              ...
              <span style={{ color: '#475569', fontWeight: '600', fontSize: '15px' }}>환불 가능 머니</span>
              <span style={{ fontSize: '20px', fontWeight: '800', color: '#f97316' }}>7,000원</span>
            </div>

            {/* 2. 환불 금액 입력 */}
            <div className="anim-item delay-2">
              <label style={{ ...labelStyle, fontSize: '14px', color: '#334155' }}>환불 신청 금액</label>
              <div style={{ position: 'relative', marginBottom: '8px' }}>
                <input
                  ...
                  style={{
                    padding: '12px 16px', fontSize: '18px', fontWeight: '600', color: '#0f172a'
                  }}
                />
              ...
              <button 
                ...
                style={{ 
                  ...
                  fontSize: '12px', color: '#ea580c', fontWeight: '800', textDecoration: 'none'
                }}
            ...
            <div className="anim-item delay-4" style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginTop: '8px' }}>
              ...
              <div style={{ backgroundColor: '#f8fafc', borderRadius: '16px', padding: '16px', border: '1px solid #f1f5f9' }}>
                <p style={{ fontSize: '11px', color: '#64748b', lineHeight: '1.8', fontWeight: '500', margin: 0 }}>
                  • 환불 신청은 영업일 기준 1-3일 이내에 처리됩니다.<br />
                  • 무통장 입금으로 충전하신 경우 해당 계좌로 환불됩니다.<br />
                  • 카드 결제의 경우 카드 취소로 처리될 수 있으며, PG사 정책에 따라 시일이 더 소요될 수 있습니다.<br />
                  • 이벤트 등으로 무상 지급된 머니는 환불이 불가능합니다.
                </p>
              </div>
