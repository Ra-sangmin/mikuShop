...
import { Briefcase, Crown, Diamond, Gift, Medal, Sparkle } from '@phosphor-icons/react';
      ...
      <div className="membership-container">
        ...
        <style jsx global>{`
          ...
          .header-section::before {
            content: '';
            position: absolute; left: -80px; bottom: -120px; width: 240px; height: 240px;
          ...
          .header-icon-badge {
            ...
            box-shadow: inset 0 1px 1px rgba(255,255,255,0.12), 0 20px 40px -12px rgba(251,191,36,0.25);
          ...
          .tier-card:nth-child(4) .tier-icon-badge { animation: diamondPulse 2.4s ease-in-out infinite; }
          @keyframes diamondPulse {
            0%, 100% { box-shadow: 0 10px 22px -6px var(--tier-color, #0ea5e9), inset 0 1px 1px rgba(255,255,255,0.5); }
            50% { box-shadow: 0 10px 30px -4px var(--tier-color, #0ea5e9), 0 0 0 8px rgba(14,165,233,0.12), inset 0 1px 1px rgba(255,255,255,0.5); }
          }
          .diamond-badge {
          ...
          .biz-banner:hover { transform: translateY(-4px); box-shadow: 0 26px 48px -12px rgba(245, 158, 11, 0.5); }
          ...
          @media (max-width: 768px) {
            ...
            .header-icon-badge { width: 100px !important; height: 100px !important; margin-top: 15px; }
            .header-icon { font-size: 48px !important; }
        ...
        <h2 className="guide-title">회원등급 및 혜택 <span className="guide-title-icon"><i className="fa fa-crown"></i></span></h2>
        ...
        <div className="guide-panel">
          ...
          <div className="header-section">
            ...
            <div className="header-icon-badge">
              <div className="header-icon" style={{ color: '#fbbf24', fontSize: '72px', lineHeight: 1 }}><Gift size="1em" weight="duotone" /></div>
            </div>
          </div>
          ...
          <div className="membership-grid">
            {membershipData.map((tier, idx) => (
              <div key={idx} className="tier-card" style={{
                ...
                <div className="tier-divider" style={{ width: '32px' }} />

                <div style={{ margin: '15px 0' }}>
                  <span className="tier-discount-label" style={{ fontSize: '11px', fontWeight: '800', color: '#94a3b8', display: 'block' }}>국제 배송비 할인</span>
                  <span className="tier-discount-val" style={{ fontSize: '28px', fontWeight: '900' }}>{tier.discount}</span>
                </div>
          ...
          <div className="membership-notice">
            ...
            <ul className="membership-notice-list">
          ...
          <div className="biz-banner" onClick={() => window.location.href='/contact'}>
            ...
            <div className="biz-banner-cta" style={{ backgroundColor: '#fff', color: '#d97706', padding: '10px 20px', borderRadius: '50px', fontWeight: '900', fontSize: '14px', whiteSpace: 'nowrap' }}>
              카톡 문의 ➔
            </div>
          </div>
        </div>
